                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit.php?id=<?= $row['id_penyakit'] ?>" class="btn btn-primary btn-action mr-1" title="Edit"><i class="fas fa-pencil-alt"></i></a>

                                                    <a href="delete.php?id=<?= $row['id_penyakit'] ?>" class="btn btn-danger btn-xs delete-data" title="hapus"><i class="fas fa-trash"></i></a>
                                                </td>
...
if (isset($_POST['submit'])) {
    ...
    if ($row > 0) {
        ...
        $save = mysqli_query($con, "INSERT INTO penyakit VALUES ('', '1', '$namapenyakit', '$solusi' )") or die(mysqli_error($con));
